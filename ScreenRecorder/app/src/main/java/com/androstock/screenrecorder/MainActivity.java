...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.lottieView).setOnTouchListener(new MyTouchListener());
    ...
    public void playVideo(View v) {
        ...
        String path = "android.resource://" + getApplicationContext().getPackageName() + "/raw/" + R.raw.video;
    ...
    private VirtualDisplay createVirtualDisplay() {
        return mMediaProjection.createVirtualDisplay("MainActivity", vid.getWidth(), vid.getHeight(), mScreenDensity,
    ...
    private void initRecorder() {
        try {
            ...
            mMediaRecorder.setOutputFile(Environment.getExternalStorageDirectory() + "/video" + strDate + ".mp4");
